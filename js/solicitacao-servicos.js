document.addEventListener("DOMContentLoaded", () => {
  ...
  const SERVICES = [
    { id: 1, name: "Consultoria em TI", price: 500.0, term: 5 },
    { id: 2, name: "Desenvolvimento de Software", price: 3500.0, term: 30 },
    { id: 3, name: "Segurança da Informação", price: 1800.0, term: 15 },
    { id: 4, name: "Suporte Técnico Remoto", price: 250.0, term: 1 },
  ];
  ...
  let initialRequests = [
    {
      date: "2024-03-15",
      id: "NXS-001",
      service: "Segurança da Informação",
      status: "Concluído",
      price: 1800.0,
    ...
    },
    {
      date: "2024-04-01",
      id: "NXS-002",
      service: "Suporte Técnico Remoto",
      status: "Em Andamento",
      price: 250.0,
  ...
  function handleAddRequest(event) {
    ...
    const newRequest = {
      ...
      expectedDate: new Date(
        new Date().setDate(new Date().getDate() + service.term)
      )
        .toISOString()
        .split("T")[0],
    };
